...
function content_sliderYTShortcode($atts,$content = null)
{
	...
	if (!defined ('OWL_CAROUSEL'))
	{
		...
		JHtml::_('script', JUri::base()."plugins/system/ytshortcodes/assets/js/owl.carousel.js", array('version' => 'auto', 'relative' => true));
		JHtml::_('stylesheet', JUri::base()."plugins/system/ytshortcodes/assets/css/owl.carousel.css", array('version' => 'auto', 'relative' => true));
