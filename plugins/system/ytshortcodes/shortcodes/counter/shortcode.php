...
function counterYTShortcode($atts = null, $content = null) {
        ...
        JHtml::_('stylesheet', JUri::base()."plugins/system/ytshortcodes/shortcodes/counter/css/counter.css");
        // Add javascript file in head
		JHtml::_('jquery.framework');
        JHtml::_('script', JUri::base()."plugins/system/ytshortcodes/assets/js/jquery.appear.js");
        JHtml::_('script', JUri::base()."plugins/system/ytshortcodes/shortcodes/counter/js/countUp.js");
