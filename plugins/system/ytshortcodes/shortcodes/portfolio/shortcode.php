...
$slides = (array)get_slides($atts);
	...
	if ( count($slides) ) {
		...
		foreach ((array) $slides as $slide) {
			if($slide['image'] == '')
			{
				$slide['image'] = 'plugins/system/ytshortcodes/assets/images/URL_IMAGES.png';
			}
		...
		JHtml::_('stylesheet', JUri::base()."plugins/system/ytshortcodes/shortcodes/portfolio/css/portfolio.css");
		JHtml::_('stylesheet', JUri::base()."plugins/system/ytshortcodes/assets/css/magnific-popup.css");

		
		JHtml::_('jquery.framework');
		JHtml::_('script', JUri::base()."plugins/system/ytshortcodes/assets/js/magnific-popup.js");
		JHtml::_('script', JUri::base()."plugins/system/ytshortcodes/shortcodes/portfolio/js/themepunch_tools.js");
		JHtml::_('script', JUri::base()."plugins/system/ytshortcodes/shortcodes/portfolio/js/themepunch_megafoliopro.js");
