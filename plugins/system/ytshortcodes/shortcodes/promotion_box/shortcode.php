...
function promotion_boxYTShortcode($atts,$content= null){
	extract(ytshortcode_atts(array(
		'type'					  => '',
		'yt_title'                   => 'This is Call To Action Title',
		'title_color'             => '#ffffff',
	...
	$id = uniqid('yt_').rand().time();
        ...
        $css .= '#'.$id.' .cta-content h3 { color:' . $promotion_color.'; margin:0; padding:0}';
        if($type=="arrow-box") {
        ...
        $return  = '<section id="'.$id.'" class="promotion cta-align-'. $align .' '.$type.'">';
