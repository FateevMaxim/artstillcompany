...
function tablesYTShortcode($atts,$content = null){
	...
	$css .= "#".$id." .table{width:".$width."; height:".$height."; background:".$background." }";
	$doc = JFactory::getDocument();
	$doc->addStyleDeclaration($css);
	//table
	$tables ="<div class='table-responsive' id='".$id."'>";
	$tables .= "<table class='table table-".$type."'>";
