...
<div class="orderby-displaynumber top clearfix">

	<div class="vm-view-list col-md-2 col-sm-3 col-xs-3 col-12">
		<div class="icon-list-grid">
			<div class="vm-view vm-grid active" data-view="vm-grid"><i class="fa fa-table" aria-hidden="true"></i></div>
			<div class="vm-view vm-list" data-view="vm-list"><i class="fa fa-list-ol" aria-hidden="true"></i></div>
		</div>
	</div>
	
	<div class="toolbar-center col-md-10 col-sm-9 col-xs-9 col-12">
