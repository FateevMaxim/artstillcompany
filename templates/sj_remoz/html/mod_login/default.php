...
<?php else : ?>
	<div class="list-inline yt-loginform">
		<ul>
			<li>
				<a class="login-switch " href="<?php echo JRoute::_('index.php?option=com_users&view=login'); ?>" title="<?php  echo JText::_('MOD_LOGIN_ME');?>"><?php echo JText::_('JLOGIN'); ?></a> <span>or</span>
