	...
	<?php
		...
		foreach ($items as $item) {
			...
			if($item->video) {
				...
				echo '<iframe class="sp-simpleportfolio-lightbox" src="'. $video_src .'" width="500" height="281" id="sp-simpleportfolio-video'.$item->spsimpleportfolio_item_id.'" style="border:none;" ></iframe>';
			}
		}
	?>
		...
		<?php foreach ($items as $item) { ?>
			...
			<div class="sp-simpleportfolio-item" data-groups='[<?php echo $groups; ?>]'>
				...
				<div class="sp-simpleportfolio-overlay-wrapper clearfix">
					...
					<div class="sp-simpleportfolio-content">
						...
						<div class="sp-vertical-middle">
							<div>
								<div class="sp-simpleportfolio-btns">
									...
									<?php } else { ?>
										<a class="btn-zoom" href="<?php echo JURI::base(true) . '/images/spsimpleportfolio/' . $item->alias . '/' . JFile::stripExt(JFile::getName($item->image)) . '_'. $square .'.' . JFile::getExt($item->image); ?>" data-featherlight="image"><?php echo JText::_('MOD_SPSIMPLEPORTFOLIO_ZOOM'); ?></a>
									<?php } ?>
