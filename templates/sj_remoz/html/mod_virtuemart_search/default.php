...
<div class="search<?php echo $params->get('moduleclass_sfx'); ?>">
	<?php $output = '<input name="keyword" id="mod_virtuemart_search" maxlength="'.$maxlength.'" placeholder="'.$text.'" class="form-control inputbox'.$moduleclass_sfx.'" type="text" size="'.$width.'" />';
 $image = JURI::base() . $imagepath;
			...
			if ($button) :
			    if ($imagebutton && $imagepath) :
			        ...
			        $button = '<button type="submit" class="btn button'.$moduleclass_sfx.'" onclick="this.form.keyword.focus();"><i class="fa fa-search"></i></button>';
			    endif;
