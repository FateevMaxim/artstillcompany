    ...
    <head>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
            <meta name="viewport" content="width=device-width, initial-scale=1">
                ...
                $this->helix3->addCSS('bootstrap.min.css, jquery.datetimepicker.css') // CSS Files
                        ->addCSS('font-awesome.min.css') // CSS Files
                        ->addJS('bootstrap.min.js, jquery.sticky.js,main.js') // JS Files
                        ->lessInit()->setLessVariables(array(
                            'preset' => $this->helix3->Preset(),
                            'bg_color' => $this->helix3->PresetParam('_bg'),
                            'text_color' => $this->helix3->PresetParam('_text'),
                            'color' => $this->helix3->PresetParam('_major'),
                ...
                $this->helix3->addLess('edit-virtuemart', 'virtuemart');
